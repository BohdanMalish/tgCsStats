...
"""
    ...
    async def gsi_stats_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        await update.message.reply_text(
            "🎮 CS2 Game State Integration (GSI)\n\n"
            "📋 Для налаштування:\n"
            "1. Скопіюй файл cs2_gsi_config.cfg\n"
            "2. Розмісти в: Steam\\steamapps\\common\\Counter-Strike Global Offensive\\csgo\\cfg\\\n"
            "3. Запусти CS2\n"
            "4. Використай команду /gsi_live для отримання статистики в реальному часі\n\n"
            "✅ Переваги GSI:\n"
            "• Дані в реальному часі\n"
            "• Нічого завантажувати не потрібно\n"
            "• Детальна статистика по матчах\n"
            ...
            "🔧 Команди:\n"
            "/gsi_live - статистика в реальному часі\n"
            "/gsi_match - інформація про поточний матч\n"
            "/gsi_weapon - статистика по зброї"
        )
